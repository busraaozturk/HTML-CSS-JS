...
const animations = ['bounce', 'shake', 'flip'];
...
themeBtn.addEventListener('click', () => {
  ...
  // SVG + Label güncelle
  span.innerHTML = isDark ? sunSVG : moonSVG;
  themeBtn.childNodes[themeBtn.childNodes.length - 1].textContent = ' ' + label;
});
