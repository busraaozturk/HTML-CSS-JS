...
function loadFromStoragr(){
    ...
    try {
        ...
        items.forEach(element => {
            createListItem(element.text, element.completed)
        });
    } catch (error) {
...
function addTask() {
    ...
    deleteBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
